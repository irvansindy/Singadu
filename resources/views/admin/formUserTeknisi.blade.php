    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Create New Teknisi</h3>
                <ol class="breadcrumb">
            ...
            <div class="card">
                ...
                <form class="form-horizontal form-material" method="post" enctype="multipart/form-data" action="{{route('storeTeknisi')}}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="password" class="form-control form-control-line" id="password" @error('password') is-invalid @enderror" name="password">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="password" class="form-control form-control-line" id="passwordConfirmation" @error('passwordConfirmation') is-invalid @enderror" name="passwordConfirmation">
